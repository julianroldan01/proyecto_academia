...
<div id="login2">
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img id="img" src="public/corte1.jpg" class="d-block w-100" srcset="corte1.jpg 1x">
            </div>
            <div class="carousel-item">
                <img id="img" src="public/corte1.jpg" class="d-block w-100" alt="..." srcset="corte2.jpg 1x">
            </div>
            <div class="carousel-item">
                <img id="img" src="public/corte1.jpg" class="d-block w-100" alt="..." srcset="corte3.jpg 1x">
            </div>
        </div>
    ...
    <span style="color: white;">
        ...
        <h3>
            <p>Cuando tienes un centro de belleza y bienestar bien sea</p>
            <p>(estética, medicina estética, peluquería, nutrición, fisioterapia, psicología,</p>
            <p>terapias alternativas, etc.) Una de las claves del éxito de tu negocio es la</p>
            <p>correcta difusión de tu marca.</p>

            <p>Hoy en día tener un negocio y no estar en internet es perder multitud de</p>
            <p>ventajas y oportunidades de alcanzar más visiblidad y más clientes.</p>
            <p>Seguro que tu competencia está en las redes sociales y tus potenciales</p>
            <p>clientes también, entonces ¿A qué esperas?</p>

            <p>Las redes sociales se han convertido en una poderosa herramienta</p>
